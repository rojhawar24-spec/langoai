...
module.exports = {
  ...
  safelist: [
    ...
    { pattern: /bg-(indigo|emerald|violet|rose|amber|cyan|purple|pink|teal|orange|slate|blue|amber|emerald|indigo)-(50|100|200|300|400|500|600|700|800|900)(\/[\d]+)?/ },
    { pattern: /text-(indigo|emerald|violet|rose|amber|cyan|purple|pink|teal|orange|slate|blue|amber|emerald|indigo)-(50|100|200|300|400|500|600|700|800|900)(\/[\d]+)?/ },
