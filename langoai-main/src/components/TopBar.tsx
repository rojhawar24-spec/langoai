...
export default function TopBar() {
  ...
  // ✅ NIEUW (accessibility-audit): Escape sluit open menu's. Zonder dit
  // kon iemand die alleen het toetsenbord gebruikt een geopend menu
  // nergens meer dichtklikken — er was geen manier om het te sluiten
  // zonder een muis.
  useEffect(() => {
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="relative" ref={menuRef}>
            <button
              ...
              aria-label={`Gebruikersmenu — ${user.username}`}
              aria-haspopup="true"
              aria-expanded={menuOpen}
            >
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 text-xs font-bold text-white shadow-sm" aria-hidden="true">
                {initials}
              </div>
