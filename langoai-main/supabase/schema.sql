...
-- Bewust niet wijzigbaar door clients: username, id en created_at.
...
-- (geen XP, streak, enz.). De onderliggende tabel blijft
...
-- Protected server-authoritative fields are intentionally not granted to clients.
