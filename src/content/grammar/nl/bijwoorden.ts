  ...
  rulesTable: [
    {
      ...
      example: "<strong>snel</strong> lopen (bijwoord) – een <strong>snelle</strong> auto (bijvoeglijk naamwoord).",
    ...
    },
    {
      ...
      example: "Ik ben <strong>gisteren</strong> (tijd) <strong>snel</strong> (wijze) <strong>naar huis</strong> (plaats) gegaan.",
    ...
    },
    {
      ...
      example: "<strong>Gisteren</strong> ging ik naar de tandarts. Ik ben <strong>gisteren</strong> naar de tandarts geweest. Ik ging <strong>gisteren</strong> naar de tandarts.",
    ...
    },
    {
      ...
      structure: "Woorden als <strong>heel, erg, tamelijk, vrij, behoorlijk, enigszins</strong> zet je vóór het bijvoeglijk naamwoord dat ze versterken of afzwakken.",
      example: "Het is <strong>heel</strong> koud, <strong>tamelijk</strong> duur, <strong>vrij</strong> gemakkelijk.",
    ...
    },
    {
      ...
      structure: "Woorden als <strong>misschien, helaas, gelukkig, natuurlijk, eigenlijk</strong> zet je vaak aan het begin van de zin, of direct na de persoonsvorm, om de gevoelswaarde te uiten.",
      example: "<strong>Misschien</strong> komt hij. Ik ben <strong>helaas</strong> te laat.",
