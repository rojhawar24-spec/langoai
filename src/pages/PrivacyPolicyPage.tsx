...
export default function PrivacyPolicyPage() {
  ...
  const thirdParties = [
    ...
    { name: t("privacy.s5.kofiName"), info: t("privacy.s5.kofiInfo"), link: "https://ko-fi.com/privacy" },
  ...
  const dataRows: [string, string, string][] = [
    ...
    [t("privacy.s2.row4cat"), t("privacy.s2.row4data"), t("privacy.s2.legalBasisContract")],
        ...
        <div className="space-y-10 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          ...
          <section>
            ...
            <ul className="ml-5 list-disc space-y-1">
              ...
              <li><strong>{t("privacy.s2.row4cat")}:</strong> {t("privacy.s4.li3")}</li>
